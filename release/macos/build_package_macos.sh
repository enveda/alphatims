...
# BUILD_NAME is taken from environment variables, e.g. alphatims-1.2.3-macos-darwin-arm64 or alphatims-1.2.3-macos-darwin-x64
...
# to avoid e.g. "Failed to load Python shared library '/Applications/AlphaTims.app/Contents/Frameworks/libpython3.8.dylib'"
cd ${CONTENTS_FOLDER}
