...
pip install "../../dist/alphatims-1.0.9-dev0-py3-none-any.whl[plotting-stable,stable,legacy-stable]"
conda list
...
if false; then
  ...
  pkgbuild --root dist/alphatims --identifier de.mpg.biochem.alphatims.app --version 1.0.9-dev0 --install-location /Applications/AlphaTims.app --scripts scripts alphatims.pkg --sign "Developer ID Installer: Max-Planck-Gesellschaft zur Förderung der Wissenschaften e.V. (7QSY5527AQ)"
  ...
  pkgbuild --root dist/alphatims --identifier de.mpg.biochem.alphatims.app --version 1.0.9-dev0 --install-location /Applications/AlphaTims.app --scripts scripts alphatims.pkg
